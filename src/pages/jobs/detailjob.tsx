...
const JobDetailPage = () => {
  ...
  const [currentSalaryType, setCurrentSalaryType] = useState(job?.salaryType || 'fixed');
  ...
  useEffect(() => {
    // Khi salaryType thay đổi, cập nhật state currentSalaryType
    const salaryType = form.getFieldValue('salaryType');
    setCurrentSalaryType(salaryType);
  }, [form.getFieldValue('salaryType')]);
    ...
    try {
      ...
      switch (values.salaryType) {
        ...
        case 'hourly':
          ...
          updatedData.salaryFixed = undefined;  // Đảm bảo reset các trường không dùng
          break;

        default:
          // Cho các trường hợp khác (nếu có)
          updatedData.salaryMin = undefined;
          updatedData.salaryMax = undefined;
          updatedData.salaryFixed = undefined;
      }
                      ...
                      >
                        <Select
                          ...
                          onChange={(value) => {
                            ...
                            setCurrentSalaryType(value); // Cập nhật state ngay lập tức
                          }}
                        >
